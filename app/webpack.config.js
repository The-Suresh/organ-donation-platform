...
module.exports = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{ from: "./src/images/4.png", to: "images/4.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/3.png", to: "images/3.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/1.png", to: "images/1.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/2.png", to: "images/2.png" }]),    
  ],
